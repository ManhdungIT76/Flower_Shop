...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 11, 2025 lúc 05:44 AM
...
('SP083', 'DM004', 'Giỏ hoa Nắng Sớm 5 ', 459000.00, 28, '1iPdDW5mtnAUmfdqndvbWrKDv6NB0_sJ', '2025-11-11 10:13:46', '2025-11-11 10:13:46'),
...
('SP237', 'DM010', 'Giỏ Trái Cây Nhập 3', 489000.00, 40, '1WxCEtHAqTw7A9O53CnrXgMuJrbh3Dv12', '2025-11-11 10:13:47', '2025-11-11 11:37:22'),
...
('SP242', 'DM010', 'Giỏ Trái Cây Nhập 4', 611000.00, 41, '1uW9v-EMVpbfFE9EuQesn6PqiJZjZaqiU', '2025-11-11 10:13:47', '2025-11-11 11:37:22'),
...
CREATE TABLE `users` (
  ...
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `role` enum('Khách hàng','Quản trị viên') DEFAULT 'Khách hàng',
